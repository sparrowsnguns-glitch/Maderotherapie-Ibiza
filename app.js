const LANG = {
  en: {
    ...
    questions: [
      ...
      {q:"What motivates you most to start?", a:["Holiday / Event","Wellbeing in body","Health & Vitality","Confidence & Transformation"]}
    ],
    results: [
      ...
      {title:"Body Refinement", lead:"Visible improvement of skin texture & firmness.", plan:"5–6 sessions • Focus: contouring & cellulite reduction."},
  ...
  de: {
    ...
    questions: [
      ...
      {q:"Was motiviert dich am meisten, jetzt zu starten?", a:["Reise / Event","Wohlfühlen im Körper","Gesundheit & Vitalität","Selbstbewusstsein & Transformation"]}
    ],
    results: [
  ...
  es: {
    ...
    questions: [
      ...
      {q:"¿Qué te motiva más a empezar?", a:["Vacaciones / Evento","Bienestar corporal","Salud & Vitalidad","Confianza & Transformación"]}
    ],
    results: [
...
function renderQuestion() {
  ...
  quizCard.innerHTML = `
    ...
    <div style="margin-top:.6rem;text-align:right;color:#666">
      Question ${idx+1} of ${LANG[currentLang].questions.length}
    </div>
  `;
...
function showResult() {
  ...
  resultCard.innerHTML = `
    ...
    <a href="https://wa.me/4915901023189?text=Hello!%20I%20would%20like%20to%20book%20a%20session." target="_blank" class="btn primary">Contact on WhatsApp</a>
